...
rcss.textContent='@media(max-width:768px){[style*="width:88%"],[style*="width: 88%"],[style*="width:60%"],[style*="width: 60%"],[style*="width:29%"],[style*="width: 29%"],[style*="width:100%"],[style*="width: 100%"]{width:100%!important;max-width:100%!important;min-width:100%!important}header .flex.items-center.gap-6{flex-wrap:wrap;gap:.5rem;justify-content:space-around}header{padding-left:1rem!important;padding-right:1rem!important}main{padding-left:.5rem!important;padding-right:.5rem!important}section{padding:.75rem!important}table{font-size:10px}table th,table td{padding:3px!important;white-space:nowrap}.grid-cols-6{grid-template-columns:repeat(2,1fr)!important}.text-2xl{font-size:1.1rem!important}.text-3xl{font-size:1.3rem!important}h1{font-size:.95rem!important}h2{font-size:.85rem!important}[style*="height: 380px"]{height:250px!important}[style*="height: 480px"]{height:300px!important}[style*="height: 200px"]{height:150px!important}[style*="background:#1B2956"],[style*="background: #1B2956"],[style*="background:#2E5A88"],[style*="background: #2E5A88"],[style*="background:#00A859"],[style*="background: #00A859"],[style*="background:#E63946"],[style*="background: #E63946"],[style*="background:#F58220"],[style*="background: #F58220"]{width:100%!important;max-width:100%!important;box-sizing:border-box!important;overflow:visible!important;word-wrap:break-word!important;white-space:normal!important;padding:8px!important}[style*="background:#1B2956"] p,[style*="background:#2E5A88"] p,[style*="background:#00A859"] p,[style*="background:#E63946"] p,[style*="background:#F58220"] p{font-size:11px!important;white-space:normal!important;overflow:visible!important}}';
